...
const StyledButton = styled.div`
	width: ${props => (props.xs3 ? '40px' : props.xs2 ? '50px' : props.xs ? '60px' : props.sm ? '70px' : props.md ? '80px' : props.lg ? '90px' : props.xl ? '100px' : props.xl2 ? '110px' : props.xl3 ? '120px' : props.xl4 ? '130px' : props.xl5 ? '140px' : props.xl6 ? '150px' : props.xl7 ? '160px' : '80px')};
	height: 40px;
